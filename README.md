...
In this project we are utilizing opensource software such as Papaparse (parser for csv) and Leaflet (to create our map). In addition, we used HTML, CSS and javascript in order to create our webpage. We also utilized scrollama.js in order to add more functionality to our scroll feature.
